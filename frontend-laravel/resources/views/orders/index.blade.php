        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex space-x-6">
                    ...
                    <a href="{{ route('orders.index') }}" class="text-blue-600 border-b-2 border-blue-600 px-3 py-2 text-sm font-medium">
                ...
                <!-- User Menu -->
                <div class="flex items-center">
                    <span class="text-sm text-gray-600 mr-4 hidden sm:inline">{{ $user['full_name'] ?? $user['email'] ?? 'User' }}</span>
                        ...
                        <div class="p-6 border-b bg-gray-50">
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                                <div class="flex items-center space-x-4">
                                    <div>
                                        <h3 class="text-lg font-medium text-gray-900">Order #{{ $order['id'] ?? 'N/A' }}</h3>
                                        <p class="text-sm text-gray-600">
                                            Placed on {{ isset($order['created_at']) ? \Carbon\Carbon::parse($order['created_at'])->format('M d, Y') : 'N/A' }}
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    @foreach($order['items'] as $item)
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <p class="text-sm font-medium text-gray-900">${{ number_format($item['price'] ?? 0, 2) }} each</p>
                                            </div>
