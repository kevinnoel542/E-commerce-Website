        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('products.index')); ?>" class="flex items-center">
...
<?php endif; ?>
                ...
                <!-- Navigation Links -->
                <?php if(App\Http\Controllers\AuthController::isAuthenticated()): ?>
                    <?php
...
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.dashboard')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('admin.dashboard'))]); ?>
                                <i class="bi bi-speedometer2 me-1"></i><?php echo e(__('Admin Dashboard')); ?>
...
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('products.index')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('products.*'))]); ?>
                                <i class="bi bi-house me-1"></i><?php echo e(__('Shop')); ?>
...
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('orders.index')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('orders.*'))]); ?>
                                <i class="bi bi-box-seam me-1"></i><?php echo e(__('My Orders')); ?>
...
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('wishlist.index')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('wishlist.*'))]); ?>
                                <i class="bi bi-heart me-1"></i><?php echo e(__('Wishlist')); ?>
...
<?php endif; ?>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-4">
                <?php if(App\Http\Controllers\AuthController::isAuthenticated()): ?>
                    ...
                    <a href="<?php echo e(route('cart.index')); ?>" class="relative text-gray-500 hover:text-gray-700">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('dashboard.user')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('dashboard.user'))]); ?>
...
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('profile.edit'))]); ?>
                                <i class="bi bi-pencil me-2"></i><?php echo e(__('Edit Profile')); ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800">
                    <?php echo e(App\Http\Controllers\AuthController::user()['full_name'] ?? (App\Http\Controllers\AuthController::user()['email'] ?? 'User')); ?>

                </div>
                <div class="font-medium text-sm text-gray-500">
                    <?php echo e(App\Http\Controllers\AuthController::user()['email'] ?? 'user@example.com'); ?></div>
            </div>
...
<?php /**PATH C:\Users\HACKER JOE\Desktop\MAIN FOLDER\E-commerce FASTAPI AND LARAVEL\frontend-laravel\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>