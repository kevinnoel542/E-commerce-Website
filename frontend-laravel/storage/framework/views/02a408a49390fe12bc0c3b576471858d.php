                                ...
                                <tr class="hover:bg-gray-50">
                                        ...
                                        <div class="flex items-center">
                                            <div class="h-16 w-16 flex-shrink-0">
                                                <img class="h-16 w-16 rounded-lg object-cover"
                                                    src="<?php echo e($product['image_url'] ?? 'https://via.placeholder.com/64x64/f3f4f6/9ca3af?text=IMG'); ?>"
                                                    alt="<?php echo e($product['name'] ?? 'Product'); ?>"
                                                    onerror="this.src='https://via.placeholder.com/64x64/f3f4f6/9ca3af?text=IMG'">
                                            </div>
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-gray-900">
                                                    <?php echo e($product['name'] ?? 'Unknown Product'); ?></div>
                                                <div class="text-sm text-gray-500">
                                                    <?php echo e(Str::limit($product['description'] ?? '', 60)); ?></div>
                                                <?php if(isset($product['sku'])): ?>
                                                    <div class="text-xs text-gray-400">SKU: <?php echo e($product['sku']); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if(isset($product['category'])): ?>
                                            <span
                                                class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full"><?php echo e($product['category']); ?></span>
                                        <?php else: ?>
                                            <span
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        $<?php echo e(number_format($product['price'] ?? 0, 2)); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo e($product['stock_quantity'] ?? 0); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap">
        ...
        <?php if(isset($pagination) && isset($pagination['total_pages']) && $pagination['total_pages'] > 1): ?>
            <div class="mt-6 flex items-center justify-between">
                <div class="text-sm text-gray-700">
                    Showing <span
                        class="font-medium"><?php echo e(($pagination['page'] - 1) * $pagination['per_page'] + 1); ?></span>
                    to <span
                        class="font-medium"><?php echo e(min($pagination['page'] * $pagination['per_page'], $pagination['total'])); ?></span>
                    of <span class="font-medium"><?php echo e($pagination['total']); ?></span> results
                </div>
                <div class="flex space-x-2">
                    <?php if($pagination['page'] > 1): ?>
                        <a href="?page=<?php echo e($pagination['page'] - 1); ?>"
                    ...
                    <?php for($i = max(1, $pagination['page'] - 2); $i <= min($pagination['total_pages'], $pagination['page'] + 2); $i++): ?>
                        <?php if($i == $pagination['page']): ?>
                            <span
                                class="px-3 py-2 text-sm bg-blue-600 text-white rounded-md"><?php echo e($i); ?></span>
                        <?php else: ?>
