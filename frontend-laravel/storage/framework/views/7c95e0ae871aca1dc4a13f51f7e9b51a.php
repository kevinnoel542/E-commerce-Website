        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6 border-b border-gray-100">
                    ...
                    <p class="text-sm text-gray-600">Fill in the details to create a new product</p>
                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" id="stock_quantity" name="stock_quantity"
                                value="<?php echo e(old('stock_quantity', 0)); ?>" min="0"
                                class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <!-- Product Images -->
                    <div>
                        <label for="images" class="block text-sm font-medium text-gray-700 mb-2">Product
                            Images</label>
                        <div
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit"
                            ...
                            <i class="bi bi-plus-circle mr-2"></i>Create Product
                        </button>
                    </div>
                </form>
            </div>
    ...
    <script>
        function previewImages(input) {
            ...
            if (input.files && input.files.length > 0) {
                // Show the preview container with grid classes
...
<?php endif; ?>
<?php /**PATH C:\Users\HACKER JOE\Desktop\MAIN FOLDER\E-commerce FASTAPI AND LARAVEL\frontend-laravel\resources\views/admin/products/create.blade.php ENDPATH**/ ?>